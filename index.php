    ...
    <main>
        <div class="food_banner" >
            ...
            <div class="search-dish">
                <div class="searchposition">
                    ...
                    <input type="text" placeholder="Search dishes" name="Search"class="searchinput">
        ...
        <div class="animation">
            <section class="restaurants">
                ...
                <div class="oyibi-restaurant"><img src="images/PAJ.webp" alt="Oyibi1"> <p>Oyibi Restaurant</p> </div>
                <div class="oyibi-restaurant"><img src="images/PAJ.webp" alt="adenta"><p>Adenta Restaurant</p></div>
                <div class="oyibi-restaurant"><img src="images/PAJ.webp" alt="madina"><p>Madina Restaurant</p></div>
                ...
                <div id="buttonId"><button type="button">Order Now</button></div>
                <div class="track">
                    <div class="track1">
                        <div class="track2">
                        ...
                        <div class="track-image">
                            <img src="images/PAJ.webp" alt="map" class="track-img">
